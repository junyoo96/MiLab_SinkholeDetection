...
class Manhole(Utility):
    def __init__(self, manhole_cover_material, manhole_cover_dielectric_smoothing_activation, water_material_identifier, water_dielectric_smoothing_activation, free_space_material_identifier, free_space_dielectric_smoothing_activation, water=False):
        ...
        self.manhole_height_offset_min=0.20
        self.manhole_height_offset_max=0.40
        self.manhole_thickness_min=0.15
        self.manhole_thickness_max=0.25
    ...
    def generate_manhole(self,domain_x,domain_y,domain_z_underground_start,antenna_y_offset,textfile):
        ...
        manhole_higher_point_y_min=antenna_y_offset+self.manhole_point_y_range_offset
        manhole_higher_point_y_max=domain_center_point_y+(offset_y_between_antenna_and_center-self.manhole_point_y_range_offset)
        manhole_higher_point_y=utility.random_sampling(manhole_higher_point_y_min,manhole_higher_point_y_max)

        domain_center_point_x = domain_x / 2
        manhole_higher_point_x_min = domain_center_point_x - self.manhole_point_x_range_offset
        manhole_higher_point_x_max = domain_center_point_x + self.manhole_point_x_range_offset
        manhole_higher_point_x = utility.random_sampling(manhole_higher_point_x_min, manhole_higher_point_x_max)

        manhole_higher_point_z=domain_z_underground_start

        manhole_lower_point_x=manhole_higher_point_x
        manhole_lower_point_y=manhole_higher_point_y
        manhole_height=utility.random_sampling(self.manhole_height_offset_min,self.manhole_height_offset_max)
        manhole_content_height=manhole_height-self.manhole_cover_thickness
        manhole_lower_point_z=manhole_higher_point_z-manhole_height
        ...
        if self.water==False:
            ...
            manhole_content_higher_point_z=manhole_lower_point_z+manhole_content_water_height
            ...
            if manhole_content_water_portion<1:
                ...
                manhole_content_higher_point_z=manhole_higher_point_z - manhole_cover_thickness
        ...
        manhole_cover=Cylinder(manhole_lower_point_x,
                                manhole_lower_point_y,
                                manhole_higher_point_z - manhole_cover_thickness,
                                manhole_lower_point_x,
                                manhole_lower_point_y,
