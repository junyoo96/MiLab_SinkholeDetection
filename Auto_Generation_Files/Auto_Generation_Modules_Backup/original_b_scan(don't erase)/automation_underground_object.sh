...
do
    # #generate inputfile
    python $INPUT_FILE_AUTOMATION_MODULES_MAIN_PY_PATH $underground_object_type_to_generate $underground_object_index $numbers_of_multiple_b_scan
    ...
    # #python -m tools.outputfiles_merge $WORKTABLE_PATH/${underground_object_type_to_generate}_${underground_object_index}
