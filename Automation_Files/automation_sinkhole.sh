...
python -m gprMax /root/Desktop/workspace/youngjun/SinkholeDetection/MiLab_SinkholeDetection/Automation_Files/input_file_generation_test_files/sinkhole_1_.in -n 1 -gpu
